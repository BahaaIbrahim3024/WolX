...
def create_album(request):
    if not request.user.is_authenticated:
        ...
        if form.is_valid():
            ...
            file_type = album.albumLogo.url.split('.')[-1]
...
def create_song(request, album_id):
    ...
    if form.is_valid():
        ...
        song.album = album
        song.fileType = request.FILES['fileType']
        file_type = song.fileType.url.split('.')[-1]
        file_type = file_type.lower()
    ...
    if not request.user.is_authenticated:
        ...
        try:
            ...
            if filter_by == 'favorites':
                users_songs = users_songs.filter(isFavorite=True)
